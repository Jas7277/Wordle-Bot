...
# Indicators is a list storing all the Indicator objects. An indicator is that button thing with all the letters you see.
indicators = []
...
def check_guess(guess_to_check):
    # Goes through each letter and checks if it should be green, yellow, or gray
